(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["UserRoles"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    delete_role: function delete_role(role_id) {
      var _this = this;
    ...
    save_edit_role: function save_edit_role(role_id) {
      var _this2 = this;
    ...
    UpdateRole: function UpdateRole(list) {
    ...
    permission_table: function permission_table() {
      ...
      axios.get('api/Permission').then(function (res) {
        _this3.permission_lists = res.data;

        for (var i = 0; i < _this3.permission_lists.length; i++) {
          _this3.permission_lists[i].created_at = moment_moment__WEBPACK_IMPORTED_MODULE_0___default()(res.data[i].created_at).format('YYYY-MM-DD');
        }
      });
    },

...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    save_edit_category: function save_edit_category(category_id) {
      var _this2 = this;
      ...
      axios.post('api/SaveEditCategory', {
        ...
        _this2.UpdateCategoryDialog = false;
      });
    },
    UpdateCategory: function UpdateCategory(list) {
    ...
    category_list_table: function category_list_table() {
      ...
      axios.get('api/Category').then(function (res) {
        _this3.category_lists = res.data;

        for (var i = 0; i < _this3.category_lists.length; i++) {
          _this3.category_lists[i].created_at = moment_moment__WEBPACK_IMPORTED_MODULE_0___default()(res.data[i].created_at).format('YYYY-MM-DD');
        }
      });
    },
